// Code from textbook
// Modified by: Rachel Tieu
// 4-27-20
//This program contains a variety of sorting algorithms such as InsertionSort, HeapSort,
//  QuickSort, and MergeSort, the sorting algorithms are able to sort the vectors according
//  to the comparator that is passed as a parameter, the sorting algorithms can sort from
 ...
 */
 // @a: the vector that we are sorting
 // @less_than: the Comparator that we pass to the sorting algorithm in order
 //   to indicate how the vector should be sorted
 ...
 */
 ...
 // @a: the vector that we are sorting
 // @left: the starting index of the vector
 // @right: the last index of the vector
 // @less_than: the Comparator that we pass to the sorting algorithm in order
 //   to indicate how the vector should be sorted
template <typename Comparable, typename Comparator>
 ...
 */
// @a: the vector that is being sorted
 ...
 */
 // @a: the vector that we are sorting
 // @i: the postition that we start to percolate down from
...
// @a: the vector that we are sorting, that holds Comparable items
// @tmpArray: the array that will hold the merged vector
// @leftPos: the first position in the array
// @rightPos: the first index of the seconf half od the array
// @rightEnd: the last element in the array
// @less_than: the Comparator that we pass to the sorting algorithm in order
//   to indicate how the vector should be sorted
template <typename Comparable, typename Comparator>
 ...
 */
// @a: the vector of Comparable items that we are sorting
// @less_than: the Comparator that we pass to the sorting algorithm in order
//   to indicate how the vector should be sorted
template <typename Comparable, typename Comparator>
 ...
 */
 // @a: the vector that we are searching through to find the median
 // @left: the starting position of the vector
 // @right: the last position of the vector
 // @less_than: the Comparator that we pass to the sorting algorithm in order
 //   to indicate how the vector should be sorted
template <typename Comparable, typename Comparator>
...
// @items: the vector of items athat we are sorting
// @less_than: the Comparator that we pass to the sorting algorithm in order
//   to indicate how the vector should be sorted
template <typename Comparable, typename Comparator>
